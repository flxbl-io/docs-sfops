...
{% hint style="info" %}
**Important:** The values in TEST_ORGS and ORGS must exactly match the environment names you created above. See [4. Trigger the workflows](./4.-trigger-the-workflows.md) for deployment instructions.
{% endhint %}
