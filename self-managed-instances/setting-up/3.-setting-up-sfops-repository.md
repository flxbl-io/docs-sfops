...
{% hint style="info" %}
Store this as a **Repository secret** in your `sfops` repository. This token is only used by the sfops repository for sync operations and doesn't need to be shared across other repositories.
{% endhint %}
...
{% hint style="info" %}
Store these as **Organization secrets/variables**. These credentials are used across all sfops repositories (sfops, sfops-gh-actions, sfops-dev-central, and your Salesforce project repositories) for GitHub App authentication.
{% endhint %}
...
{% hint style="info" %}
Store these as **Repository secrets** in your `sfops` repository. These are only used by the sfops repository for Docker operations.
{% endhint %}
...
{% hint style="info" %}
Store these as **Repository secrets/variables** in your `sfops` repository. These are only used by the sfops repository for pulling base images during Docker operations.
{% endhint %}
